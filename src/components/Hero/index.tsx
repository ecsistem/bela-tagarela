...
<h1 className="text-lg font-normal text-green-tertiary text-center my-4">Faça donwload do nosso APP</h1>
                    <div className="flex w-full my-3 justify-center gap-4">
    <button className="bg-green-primary flex items-center text-white justify-center gap-x-3 text-sm sm:text-base   rounded-lg hover:bg-green-hover duration-300 transition-colors border px-8 py-2.5">
